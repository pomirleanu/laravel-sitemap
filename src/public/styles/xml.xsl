...
.url:hover
{
  ...
  <body>
	<div id="content">
	  	<h2>XML Sitemap</h2>
		<p class="expl">Generated by <a href="https://github.com/pomirleanu/laravel-sitemap" target="_blank" title="Sitemap generator for Laravel">laravel-sitemap</a>. This is styled xml sitemap, sorted by update date.</p>
